                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            <a class="btn btn-primary " href="data_siswa.php">Tambah Data</a>
                                        </tr>
                                        <tr>
                                            <th>No</th>
                                            <th>ID</th>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-primary " href="edit_siswa.php?id=<?php echo $data['id_siswa'];?>">Edit</a>
                                                
                                                <div class="form-group"></div>
                                                <a class="btn btn-primary " onclick="return confirm('Anda Yakin ?')" href="hapus_siswa.php?id=<?php echo $data['id_siswa']; ?>">Hapus</a>
                                            </td>
                                        </tr>    
                                        <?php } ?>
                                    </thead>
