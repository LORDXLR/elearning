...
<div class="form-group">
    <label>1. Sinonim kata Pergi adalah ? </label>
    <div class="radio">
        <label>
...
<div class="form-group">
    <label>3. Antonim kata baik adalah ? </label>
    <div class="radio">
        <label>
...
<div class="form-group">
    <label>4. Arti dari apotik adalah ? </label>
    <div class="radio">
        <label>
...
<div class="form-group">
    <label>5. Lawan kata kecil adalah ? </label>
    <div class="radio">
        <label>
