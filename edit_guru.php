<?php
    include "koneksi.php";
    $id = $_GET['id'];
    $qe = mysqli_query($koneksi,"SELECT * FROM guru WHERE id_guru='$id'");
...
<?php
    if (isset($_POST['edit'])) {
        ...
        $tambah = mysqli_query($koneksi,"UPDATE  guru SET nama='$nama',username='$username',password='$password',jenis_kelamin='$jenisk',alamat='$alamat',tgl_lahir='$tgll',bdng_studi='$bidangs',email='$email' WHERE id_guru='$id'
             ");
        if ($tambah){
            echo "Edit berhasil";
        }else{
                                ...
                                <div class="col-md-6">
                                    <form method="post" role="form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="bs" value="<?php echo $data['bdng_studi'];?>" class="form-control">
                                    ...
                                    <div class="form-group"></div>
                                    <a onclick="return confirm('Apakah anda ingin kembali ?')" class="btn btn-primary"  href="list_guru.php">Kembali</a>
