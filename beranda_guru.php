    ...
    <div class="panel-heading">  </div>
        <div class="panel-body">
            <div class="table-responsive">
              ...
              <div>
                <div>
                  <a href="user_guru.php">o Ubah Data Anda</a>
                </div>
                <div>
                  <a href="pengumuman.php">o Kelola Pengumuman</a>
                </div>
                <div>
                  <a href="materi.php">o Kelola Materi</a>
                </div>
                <div>
                  <a href="tkelas5.php">o Kelola Soal dan Tugas</a>
                </div>
                <div>
                  <a href="kelas.php">o Kelola Nilai Siswa</a>
                </div>
              </div>
