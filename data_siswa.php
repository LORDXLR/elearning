        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2>Data Siswa</h2>   
                        <h5>Silahkan Masukan Data Siswa</h5>
                    </div>
                </div> 
<!-- ============================ Garis =============================  -->
                 <hr />
...
<?php
    if (isset($_POST['simpan'])) {
        ...
        $tambah = mysqli_query($koneksi,"INSERT INTO siswa(nama,username,password,jenis_kelamin,alamat,tgl_lahir,kelas,email)VALUES('$nama','$username','$password','$jenisk','$alamat','$tgll','$kelas','$email')");
        if ($tambah){
            echo "berhasil";
        }else{
            echo "gagal";
