<?php
    ...
    ob_start();
    session_start();
    if(!isset($_SESSION['username'])) header("login_guru.php");
    include "koneksi.php";
    ...
    /* PROSES LOGIN */
        if(isset($_POST['login_now'])) {
           ...
           $sql_login = mysqli_query($koneksi, "SELECT * FROM guru WHERE username = '$username' AND password = '$password'");
           if(mysqli_num_rows($sql_login)>0) {
              $row_akun = mysqli_fetch_array($sql_login);
              $_SESSION['guru_id'] = $row_akun['id'];
              $_SESSION['username'] = $row_akun['username'];
              header("location: beranda_guru.php");
           }else {
              header("location: login_guru.php?login-gagal");
           }
        }
?>
    ...
    <div class="container">
        <div class="row text-center">
            ...
            <br /><br />
                ...
                <h5>(Silahkan Login Sebagai Guru)</h5>
                 <br />
            </div>
    <div class="row ">
