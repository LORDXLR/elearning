...
<?php
    if (isset($_POST['upload'])) {
        ...
        $tambah = mysqli_query($koneksi,"INSERT INTO materi(id_materi,judul_materi,nama_materi,mapel,file_materi)VALUES('$id','$judul','$materi','$mapel','$nama_file')");
        if ($tambah){
            echo "berhasil";
        }else{
            echo "gagal";
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <a href="list_materi.php" class="btn btn-primary " name="upload">List Materi</a>
