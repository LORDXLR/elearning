...
<!-- ============================ Mulai Konten =============================  --> 
 <div class="panel panel-default">
    <div class="panel-heading">Nilai Siswa
    </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="panel panel-default">                        
                        <div class="panel-heading">Nilai Ujian</div>
                            <a class="btn btn-primary " href="nukelas5a.php">Nilai Kelas 5A</a>
                            <a class="btn btn-primary " href="nukelas5b.php">Nilai Kelas 5B</a>
                            <a class="btn btn-primary " href="nukelas6a.php">Nilai Kelas 6A</a>
                            <a class="btn btn-primary " href="nukelas6b.php">Nilai Kelas 6B</a> 
                    </div>    
                    <div class="panel panel-default">
                        <div class="panel-heading">Nilai Tugas</div>
                            <a class="btn btn-primary " href="ntkelas5a.php">Nilai Kelas 5A</a>
                            <a class="btn btn-primary " href="ntkelas5b.php">Nilai Kelas 5B</a>
                            <a class="btn btn-primary " href="ntkelas6a.php">Nilai Kelas 6A</a>
                            <a class="btn btn-primary " href="ntkelas6b.php">Nilai Kelas 6B</a>                       
